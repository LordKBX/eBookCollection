...
class HomeWindow(QMainWindow, HomeWindowCentralBlock, HomeWindowInfoPanel, HomeWindowSortingBlockTree, MetadataWindow):
    def __init__(self, database: bdd.BDD, translation: Lang, argv: list, env_vars: dict):
        ...
        # self.sorting_block_search_area = QtWidgets.QScrollArea()
        # self.sorting_block_search_area_contents = QtWidgets.QWidget()
    ...
    def set_style(self):
        ...
        self.sorting_block_tree.setStyleSheet(get_style_var(self.app_style, 'fullTreeView') + "QTreeView{ background:transparent; }")
