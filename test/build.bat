...
copy D:\CODES\Python\EbookCollection\test\reader\library.exe D:\CODES\Python\EbookCollection\test\build\
copy D:\CODES\Python\EbookCollection\test\reader\*.ui D:\CODES\Python\EbookCollection\test\build\
